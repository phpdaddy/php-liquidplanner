...
class LiquidPlanner
{
     ...
     * @access public
     */
    public function clients_comments($clientid = NULL, $commentid = NULL)
    {
    ...
    /**
     * Creates a new assigment in Liquid Planner
     *
     * @param  array $data Values to apply to the newly created assignment
     *
     * @return array  Response from Liquid Planner
     *
     * @access public
     ...
     * @access public
     */
    public function assignments_remove($liquidTaskId, $assignmentId)
    {
        $url = $this->serviceurl . '/tasks/' . $liquidTaskId . '/assignments/' . $assignmentId;
        $response = $this->lp_delete($url);
        return ($response);
    }
